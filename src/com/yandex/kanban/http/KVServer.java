...
public class KVServer {
    ...
    private void load(HttpExchange h) {
        ...
        try {
            System.out.println("\n/load");
            if (!this.hasAuth(h)) {
                System.out.println("Запрос не авторизован, нужен API_TOKEN со значением API-ключа");
            ...
            if (key.isEmpty()) {
                System.out.println("Key для сохранения пуст. Key указывается в пути: /load/-key-");
    ...
    private void save(HttpExchange h) throws IOException {
        try {
            System.out.println("\n/save");
            if (!hasAuth(h)) {
                System.out.println("Запрос неавторизован, нужен API_TOKEN со значением апи-ключа");
